...
export default function Users() {
  ...
  return (
    <div className="p-8 font-body max-w-7xl mx-auto">
      <header className="mb-8 border-b border-gray-200 pb-4 flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-display font-semibold text-navy">User Management</h1>
          <p className="text-gray-600 mt-2">Manage system access and assign roles to users.</p>
        </div>
      </header>
